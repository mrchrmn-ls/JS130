...
function GraduateStudent(firstName, lastName, age,
                         gender, degree, graduateDegree) {
...
function fromMixin(caller, owner, method) {
  return function() {
    return owner[method].apply(caller, ...arguments);
  };
}
...
function extend(obj, mixin) {
  ...
  methods.forEach(method => {
    obj[method] = fromMixin(obj, mixin, method);
  });
