...
let CustomSet = require('./16-custom-set.js');

describe("CustomSet", () => {
  xdescribe("empty: returns true if the set contains no elements", () => {
  ...
  xdescribe("isSame: sets with the same elements are equal", () => {
